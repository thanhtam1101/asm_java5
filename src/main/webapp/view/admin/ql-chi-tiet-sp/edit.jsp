            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body  px-4">
                        ...
                        <sf:form method="POST" action="/spct/update/${data.id}" modelAttribute="data" class="mt-4 ">
                            <div class="col-12 d-flex">
                                <div class="col-6">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <sf:input type="text" class="form-control" path="maSPCT"/>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <sf:input type="number" class="form-control" path="donGia"/>
