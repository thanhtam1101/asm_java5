                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="i" items="${listHDCT}" varStatus="hd">
                                <tr>
                                    <th scope="row">${i.idHoaDon}</th>
                                    <td>
                                        <c:forEach var="ctsp" items="${listCTSP}">
                                                    <c:if test="${i.idSPCT == ctsp.id}">${ctsp.maSPCT}</c:if>
                                        </c:forEach>
                                    </td>
                                    <td>
                                        <c:forEach var="ctsp" items="${listCTSP}">
                                            <c:if test="${ctsp.id == i.idSPCT}">
                                    ...
                                    <td>${i.donGia}</td>
                                    <td>
                                        <fmt:formatDate value="${i.thoiGian}"
