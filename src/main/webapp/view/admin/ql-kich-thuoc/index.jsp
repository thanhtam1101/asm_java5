            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <sf:form method="POST" action="/kich-thuoc/store" class="mt-4" modelAttribute="data">
                            <div class="row mb-3">
                                <label class="col-sm-4 col-form-label">ID</label>
                                <div class="col-sm-8">
                                    <sf:input type="number" class="form-control" path="id"/>
                                    <p style="color: red">${duplicateId}</p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="i" items="${pageData.content}" varStatus="ms">
                                <tr>
                                    <th scope="row">${i.id}</th>
                                    <td>${i.ma}</td>
                                    <td>${i.ten}</td>
                                    <td>
                                        <a href="/kich-thuoc/edit/${i.id}">
...
<script>
    function confirmDelete(id) {
        if (confirm('Bạn có chắc muốn xóa không?')) {
            window.location.href = '/kich-thuoc/delete/' + id;
        }
    }
</script>
