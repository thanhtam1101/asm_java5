            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body  px-4">
                        ...
                        <sf:form method="POST" action="/mau-sac/update/${data.id}" class="mt-4" modelAttribute="data">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">ID</label>
                                <div class="col-sm-10">
                                    <sf:input type="number" class="form-control" readonly="true" path="id"/>
