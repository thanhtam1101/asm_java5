            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <sf:form method="POST" action="/mau-sac/store" class="mt-4" modelAttribute="data">
...
<script>
    function confirmDelete(id) {
        if (confirm('Bạn có chắc muốn xóa không?')) {
            window.location.href = '/mau-sac/delete/' + id;
        }
    }
</script>
