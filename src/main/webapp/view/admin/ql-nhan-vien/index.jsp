...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link " href="/nhan-vien/index">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <c:forEach var="i" items="${pageData.content}" varStatus="nv">
                                <tr>
...
<script>
    function confirmDelete(id) {
        if (confirm('Bạn có chắc muốn xóa không?')) {
            window.location.href = '/nhan-vien/delete/' + id;
        }
    }
</script>
